...
public class VertifCode {
    ...
    public VertifCode(String createTypeFlag, int... codeLength) {
    	if (codeLength.length == 1) {
        ...
        random = drawRandomNum((Graphics2D) g,createTypeFlag);//根据客户端传递的createTypeFlag标识生成验证码图片
    }
