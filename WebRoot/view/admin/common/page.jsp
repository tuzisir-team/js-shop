...
<ul class="pagination">
        ...
        <c:if test="${requestScope.viewpage.totalPage > 1 && requestScope.viewpage.currentPage == 1}">
            ...
            <c:forEach var="i" begin="${requestScope.viewpage.start}" end="${requestScope.viewpage.end}" step="1">
            	...
            	<c:if test="${requestScope.viewpage.currentPage != i}">
               		<li class="page-item">
               			<a class="page-link" href="${pageContext.request.contextPath}/route?get_type=${requestScope.viewpage.route}&currentpage=${i}">${i}</a>
            		</li>
            	</c:if>
            </c:forEach>
            <li class="page-item">
            	<a class="page-link" href="${pageContext.request.contextPath}/route?get_type=${requestScope.viewpage.route}&currentpage=${requestScope.viewpage.currentPage+1}">下一页</a>
           	</li>
        </c:if>
        ...
        <c:if test="${requestScope.viewpage.currentPage > 1 && requestScope.viewpage.currentPage < requestScope.viewpage.totalPage}">
            <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/route?get_type=${requestScope.viewpage.route}&currentpage=${requestScope.viewpage.currentPage-1}">上一页</a></li>
            <c:forEach var="i" begin="${requestScope.viewpage.start}" end="${requestScope.viewpage.end}" step="1">
                <c:if test="${requestScope.viewpage.currentPage == i}"><li class="page-item active"><a class="page-link" href="">${i}</a></li></c:if>
                <c:if test="${requestScope.viewpage.currentPage != i}"><li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/route?get_type=${requestScope.viewpage.route}&currentpage=${i}">${i}</a></li></c:if>
            </c:forEach>
            <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/route?get_type=${requestScope.viewpage.route}&currentpage=${requestScope.viewpage.currentPage+1}">下一页</a></li>
        </c:if>
